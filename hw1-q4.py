...
class LogisticRegression(nn.Module):
    ...
    def __init__(self, n_classes, n_features, **kwargs):
        ...
        #Linear model therefore linear layers
        self.hLayer1 = torch.nn.Linear(n_features, n_classes)
        self.outLayer = torch.nn.Linear(n_classes, 1)
    ...
    def forward(self, x, **kwargs):
        ...
        return self.outLayer(torch.sigmoid(self.hLayer(x)))
